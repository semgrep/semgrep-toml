...
(**
    Functions for parsing toml programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a toml program from a string into a typed OCaml CST.
...
(** Parse a toml program from a file into a typed OCaml CST.
